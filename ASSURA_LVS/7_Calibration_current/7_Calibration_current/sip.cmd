...
sip -V -s -cgnd 2 -sub 2 -L3A -h -R met2 -b poly1,pdiff,fox -t 	met2cap,met3,met4 -k met1:0.665 -Maxw 9.75 -p 	poly2,key,met2:met2_cut,key 0,6.5,0 - poly2_met2.sip
sip -V -s -cgnd 2 -sub 2 -h -b poly1,pdiff,fox -t 	met2,met2cap,met3,met4 -Maxw 9.75 -p poly2,key,met1:met1_cut,key 	0,6.5,0 - poly2_met1.sip
sip -V -s -cgnd 2 -sub 2 -L3A -h -R met1 -b pdiff,fox -t 	met2,met2cap,met3,met4 -Maxw 7.5 -p 	poly1:poly1_cut,key,met1:met1_cut,key 0,4.5,0 - poly1_met1.sip
sip -V -s -cgnd 2 -sub 2 -h -R poly2,poly1 -b pdiff,fox -t 	met1,met2,met2cap,met3,met4 -Maxw 9.75 -p 	poly1:poly1_cut,key,poly2,key 0,6.5,0 - poly1_poly2.sip
...
sw3d -V -cgnd 2 -sub 2 -b poly1,pdiff,fox -t 	met2,met2cap,met3,met4 -p poly2,met1:met1_cut - poly2_met1.sw3d
sw3d -V -cgnd 2 -sub 2 -b pdiff,fox -t 	met1,met2,met2cap,met3,met4 -p poly1:poly1_cut,poly2 - 	poly1_poly2.sw3d
